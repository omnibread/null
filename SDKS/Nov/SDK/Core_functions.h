...
bool UObject::IsA ( UClass* pClass )
{
	...
	{
		if ( SuperClass && SuperClass == pClass )
			return true;
	}
...
int UObject::FindObjectIndex ( char* objectFullName, UClass* pStaticClass )
{
	for( int i = 0; i < UObject::GObjObjects()->Count; ++i )
	{
		UObject* Object = UObject::GObjObjects()->Data[i];
...
template< typename T > T* UObject::FindProperty ( char* propertyName, UClass* pStaticClass )
{
	...
	for( unsigned int k = 0; k < vChildren.size(); ++k )
	{
		...
		if( pProperty && strcmp( pProperty->GetName(), propertyName ) == 0 )
		{
...
int UObject::FindPropertyOffset ( char* propertyName, UClass* pStaticClass )
{
	if( pStaticClass == NULL )
	{
		if( this->Class == NULL )
...
struct FVector2D UObject::SubtractEqual_Vector2DVector2D ( struct FVector2D B, struct FVector2D* A )
{
	...
	if ( ! pFnSubtractEqual_Vector2DVector2D )
		pFnSubtractEqual_Vector2DVector2D = UObject::FindObject<UFunction> ( "Function Core.Object.SubtractEqual_Vector2DVector2D" );
...
struct FVector2D UObject::AddEqual_Vector2DVector2D ( struct FVector2D B, struct FVector2D* A )
{
	...
	if ( ! pFnAddEqual_Vector2DVector2D )
		pFnAddEqual_Vector2DVector2D = UObject::FindObject<UFunction> ( "Function Core.Object.AddEqual_Vector2DVector2D" );
...
struct FVector2D UObject::DivideEqual_Vector2DFloat ( float B, struct FVector2D* A )
{
	...
	if ( ! pFnDivideEqual_Vector2DFloat )
		pFnDivideEqual_Vector2DFloat = UObject::FindObject<UFunction> ( "Function Core.Object.DivideEqual_Vector2DFloat" );
...
struct FVector2D UObject::MultiplyEqual_Vector2DFloat ( float B, struct FVector2D* A )
{
	...
	if ( ! pFnMultiplyEqual_Vector2DFloat )
		pFnMultiplyEqual_Vector2DFloat = UObject::FindObject<UFunction> ( "Function Core.Object.MultiplyEqual_Vector2DFloat" );
...
struct FVector2D UObject::Divide_Vector2DFloat ( struct FVector2D A, float B )
{
	...
	if ( ! pFnDivide_Vector2DFloat )
		pFnDivide_Vector2DFloat = UObject::FindObject<UFunction> ( "Function Core.Object.Divide_Vector2DFloat" );
...
struct FVector2D UObject::Multiply_Vector2DFloat ( struct FVector2D A, float B )
{
	...
	if ( ! pFnMultiply_Vector2DFloat )
		pFnMultiply_Vector2DFloat = UObject::FindObject<UFunction> ( "Function Core.Object.Multiply_Vector2DFloat" );
