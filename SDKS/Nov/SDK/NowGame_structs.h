...
struct FPendingCombatMoves
{
	...
	int                                                CombatReqEnum;                                    		// 0x0008 (0x0004) [0x0000000000000000]              
	struct FString                                     AddB;                                             		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     TellB;                                            		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      AddBOnTarget : 1;                                 		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bTrace : 1;                                       		// 0x0024 (0x0004) [0x0000000000000000] [0x00000002] 
};
