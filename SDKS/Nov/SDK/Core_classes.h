...
public:
	...
	template< class T > static T* FindObject ( char* objectFullName, UClass* pStaticClass = NULL ); 
	static int UObject::FindObjectIndex ( char* objectFullName, UClass* pStaticClass = NULL );
	template< typename T > T* FindProperty ( char* propertyName, UClass* pStaticClass = NULL );
	int FindPropertyOffset ( char* propertyName, UClass* pStaticClass = NULL );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x0046AD00 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00482560 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x004809C0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x004028B0 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x004028C0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x004028D0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x004DFBF0 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004DFC40 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x0046ACA0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x004E39B0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004028E0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x004DAF50 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00474050 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x0047F1F0 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x004DA050 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x0042F2A0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x004D93C0 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004DF5E0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x004D9400 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x004D9410 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004DF6B0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004D9F30 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004D9460 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004D9FC0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x004028F0 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00402900 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x004D9430 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004D9440 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004D9F60 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004D9450 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004D9F90 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004E0ED0 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004DF7A0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004DF8E0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00402910 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00471460 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x004EEED0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00408160 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00408190 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x004081C0 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x0040AD80 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00402920 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00402930 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00402940 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00402950 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x0042B4E0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00A055F0 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00A12720 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x004F1030 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x00478000 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00402960 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00402970 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x0046AB40 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00480760 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x004E01A0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x0042B4F0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x004D9EE0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x0042B500 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004EE5D0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x00402990 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x004029A0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x004029B0 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x004029D0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x004F1610 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x004D9470 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x0047DB40 (0x104)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x004A1720 (0x108)
};
...
{
public:
	unsigned char                                      UnknownData00[ 0x118 ];                           		// 0x003C (0x0118) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[ 0xA4 ];                            		// 0x0154 (0x00A4) MISSED OFFSET
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class Core.LinkerSave" );
...
// 0x05BC (0x0710 - 0x0154)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x5BC ];                           		// 0x0154 (0x05BC) MISSED OFFSET
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class Core.LinkerLoad" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class Core.Interface" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class Core.MapProperty" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class Core.InterfaceProperty" );
...
{
public:
	UProperty*                                      Inner;                             		// 0x0084 (0x0004) MISSED OFFSET
...
// Class Core.Class
// 0x00EC (0x01C4 - 0x00D8)
class UClass : public UState
{
public:
	unsigned char                                      UnknownData00[ 0xEC ];                            		// 0x00D8 (0x00EC) MISSED OFFSET
