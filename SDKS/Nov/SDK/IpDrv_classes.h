...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.ClientBeaconAddressResolver" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.HTTPDownload" );
...
// 0x0018 (0x0304 - 0x02EC)
class AInternetLink : public AInfo
{
public:
	unsigned char                                      LinkMode;                                         		// 0x02EC (0x0001) [0x0000000000000000]              
	unsigned char                                      InLineMode;                                       		// 0x02ED (0x0001) [0x0000000000000000]              
	unsigned char                                      OutLineMode;                                      		// 0x02EE (0x0001) [0x0000000000000000]              
	unsigned char                                      ReceiveMode;                                      		// 0x02EF (0x0001) [0x0000000000000000]              
	struct FPointer                                    Socket;                                           		// 0x02F0 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                Port;                                             		// 0x02F4 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    RemoteSocket;                                     		// 0x02F8 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    PrivateResolveInfo;                               		// 0x02FC (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                DataPending;                                      		// 0x0300 (0x0004) [0x0000000000000002]              ( CPF_Const )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.InternetLink" );
...
{
public:
	unsigned char                                      LinkState;                                        		// 0x0304 (0x0001) [0x0000000000000000]              
	struct FIpAddr                                     RemoteAddr;                                       		// 0x0308 (0x0008) [0x0000000000000000]              
	class UClass*                                      AcceptClass;                                      		// 0x0310 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x0314 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x0320 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.TcpLink" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.MCPBase" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.OnlineEventsInterfaceMcp" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.OnlineNewsInterfaceMcp" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.OnlineTitleFileDownloadMcp" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.MeshBeacon" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.MeshBeaconClient" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.MeshBeaconHost" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.OnlineSubsystemCommonImpl" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.OnlineGameInterfaceImpl" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.PartyBeacon" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.PartyBeaconClient" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.PartyBeaconHost" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.TcpipConnection" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.TcpNetDriver" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.WebRequest" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.WebResponse" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.WebApplication" );
...
// 0x014C (0x0478 - 0x032C)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                       		// 0x032C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x0338 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x03B0 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	...
	struct FString                                     ServerURL;                                        		// 0x043C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x0448 (0x0028) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.WebServer" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.HelloWeb" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.ImageServer" );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.IniLocPatcherMcp" );
...
{
public:
	class AWebServer*                                  WebServer;                                        		// 0x032C (0x0004) [0x0000000000000000]              
	struct FString                                     ReceivedData;                                     		// 0x0330 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebRequest*                                 Request;                                          		// 0x033C (0x0004) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0340 (0x0004) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x0344 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x0348 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x034C (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x0350 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x0354 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnID;                                           		// 0x0358 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindObject<UClass> ( "Class IpDrv.WebConnection" );
