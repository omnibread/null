...
unsigned long GObjects			= 0x0319C23C;
unsigned long GNames			= 0x0319C20C;
...
public:
	...
	public:
		...
		{
		public:
			unsigned char			UnknownData00[ 0x8 ];					// 0x0044 (0x08)
		...
		public:
			...
			public:
				...
				{
				public:
					unsigned char			UnknownData00[ 0xEC ];					// 0x00D8 (0xEC)
		...
		public:
			...
			FQWord				PropertyFlags;								// 0x004C (0x08)
			unsigned char		UnknownData00[ 0x10 ];						// 0x0054 (0x10)
			unsigned long		Offset;										// 0x0064 (0x04)
			unsigned char		UnknownData01[ 0x1C ];						// 0x0068 (0x1C)
		...
		public:
			...
			{
			public:
				unsigned long		BitMask;									// 0x0084 (0x04)			
			...
			{
			public:
				unsigned char			UnknownData00[ 0x8 ];						// 0x0084 (0x08)
			...
			{
			public:
				class UClass*		PropertyClass;								// 0x0084 (0x04)
			...
			public:
				...
				{
				public:
					class UClass*		MetaClass;									// 0x0088 (0x04)
			...
			{
			public:
				class UClass*		InterfaceClass;								// 0x0084 (0x04) 
			...
			{
			public:
				class UStruct*		Struct;										// 0x0084 (0x04)
			...
			{
			public:
				class UProperty*	Inner;										// 0x0084 (0x04)
			...
			{
			public:
				class UProperty*	Key;										// 0x0084 (0x04)
				class UProperty*	Value;										// 0x0088 (0x04)
