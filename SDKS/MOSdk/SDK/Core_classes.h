...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00469200 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00480200 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0047E670 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00402890 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x004028A0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x004028B0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x004DAE00 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x004DAE50 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x004691A0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x004DE980 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004028C0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x004D6210 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00472170 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x0047CFF0 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x004D52C0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x0042EDF0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x004D4630 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x004DA7F0 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x004D4670 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x004D4680 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x004DA8C0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x004D51A0 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004D46D0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004D5230 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x004028D0 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x004028E0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x004D46A0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004D46B0 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004D51D0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004D46C0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004D5200 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004DC110 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x004DA9B0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x004DAAF0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x004028F0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x0046F880 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x004E98E0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00408120 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00408150 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00408180 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x0040AC50 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00402900 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00402910 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00402920 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00402930 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x0042AFE0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x009EE290 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x009FAF60 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x004EB920 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x00476120 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00402940 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00402950 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00469040 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x0047E410 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x004DB3B0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x0042AFF0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x004D5150 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x0042B000 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x004E9000 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x00402970 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x00402980 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x00402990 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x004029B0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x004EBF00 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x004D46E0 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x0047B940 (0x104)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x0049E7C0 (0x108)
};
...
{
public:
	DWORD			ScriptText;				// NOT AUTO-GENERATED PROPERTY
	DWORD			CppText;				// NOT AUTO-GENERATED PROPERTY
	UField*			Children;				// NOT AUTO-GENERATED PROPERTY
	DWORD			PropertySize;			// NOT AUTO-GENERATED PROPERTY
	TArray<BYTE>	Script;					// NOT AUTO-GENERATED PROPERTY
	unsigned char	unknown_data0x1[0x30];	// NOT AUTO-GENERATED PROPERTY
