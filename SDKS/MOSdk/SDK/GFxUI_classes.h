...
public:
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                        		// 0x0164 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	void SetMovieCanReceiveKeyInput ( unsigned long bCanReceiveKeyInput );
...
{
public:
	unsigned long                                      bUsesFontlib : 1;                                 		// 0x0060 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bSetSRGBOnImportedTextures : 1;                   		// 0x0060 (0x0004) [0x0000000000020001] [0x00000002] ( CPF_Edit | CPF_EditConst )
	unsigned long                                      bPackTextures : 1;                                		// 0x0060 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	...
	struct FQWord                                      ImportTimeStamp;                                  		// 0x008C (0x0008) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                        		// 0x006C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
