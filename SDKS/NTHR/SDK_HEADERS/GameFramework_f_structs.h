...
struct UGameAICommand_execGetDebugOverheadText_Parms
{
	...
	TArray< struct FString >                           OutText;                                          		// 0x0008 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct AGamePlayerController_eventWarmupPause_Parms
{
	...
	// struct FString                                  MovieName;                                        		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FString                                     MovieName;                                        		// 0x0000 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct AGamePlayerController_eventClientPlayMovie_Parms
{
	...
	int                                                InStartOfRenderingMovieFrame;                     		// 0x0010 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                InEndOfRenderingMovieFrame;                       		// 0x0014 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bRestrictPausing : 1;                             		// 0x0018 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	unsigned long                                      bPlayOnceFromStream : 1;                          		// 0x001C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	unsigned long                                      bOnlyBackButtonSkipsMovie : 1;                    		// 0x0020 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
};
...
struct AGamePlayerController_execSetSoundMode_Parms
{
	...
	// unsigned long                                   bSet : 1;                                         		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UGameCheatManager_execOnRequestComplete_Parms
{
	...
	// TArray< struct FString >                        Headers;                                          		// 0x0014 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FString                                  Header;                                           		// 0x0024 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FString                                  Payload;                                          		// 0x0034 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct UGameCheatManager_execTestHttp_Parms
{
	...
	struct FString                                     Payload;                                          		// 0x0010 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     URL;                                              		// 0x0020 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	unsigned long                                      bSendParallelRequest : 1;                         		// 0x0030 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
{
	struct FString                                     ReturnValue;                                      		// 0x0000 (0x0010) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// struct FString                                  BehaviorString;                                   		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FString                                     ReturnValue;                                      		// 0x0000 (0x0010) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// struct FString                                  DestString;                                       		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct AGameCrowdAgent_eventPostRenderFor_Parms
{
	...
	// struct FString                                  ScreenName;                                       		// 0x004C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FString                                  DestString;                                       		// 0x005C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FString                                  BehaviorString;                                   		// 0x006C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct AGameCrowdAgent_eventHandleBehaviorEvent_Parms
{
	...
	unsigned long                                      bViralCause : 1;                                  		// 0x000C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	unsigned long                                      bPropagateViralFlag : 1;                          		// 0x0010 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	// unsigned long                                   bActivatedBehavior : 1;                           		// 0x0014 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class APlayerController*                           PC;                                               		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	// unsigned long                                   bFoundBehavior : 1;                               		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	// int                                             I;                                                		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct AGameCrowdAgent_execInitializeAgent_Parms
{
	...
	unsigned long                                      bWarmupPosition : 1;                              		// 0x002C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	unsigned long                                      bCheckWarmupVisibility : 1;                       		// 0x0030 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	// unsigned long                                   bGroupDestination : 1;                            		// 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bRealPreferVisible : 1;                           		// 0x0038 (0x0004) [0x0000000000000000] [0x00000001] 
	...
	// unsigned long                                   bVisibleTryLoc : 1;                               		// 0x0098 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bFoundOption : 1;                                 		// 0x009C (0x0004) [0x0000000000000000] [0x00000001] 
	...
	// unsigned long                                   bVisibleOption : 1;                               		// 0x00D0 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameCrowdAgent_execDisplayDebug_Parms
{
	...
	// struct FString                                  T;                                                		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct AGameCrowdAgentSkeletal_execCreateAttachments_Parms
{
	...
	// unsigned long                                   bUseSocket : 1;                                   		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bUseBone : 1;                                     		// 0x0020 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UGameCrowdAgentBehavior_execTriggerCrowdBehavior_Parms
{
	...
	unsigned long                                      bRequireLOS : 1;                                  		// 0x0028 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
struct AGameCrowdDestination_execDrawDebug_Parms
{
	...
	unsigned long                                      bPresistent : 1;                                  		// 0x0010 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
struct AGameCrowdDestination_execAnalyzeSpawnPoint_Parms
{
	...
	unsigned long                                      bForceNavMeshPathing : 1;                         		// 0x0014 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
...
struct AGameCrowdDestination_eventAllowableDestinationFor_Parms
{
	...
	unsigned long                                      ReturnValue : 1;                                  		// 0x0008 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// int                                             I;                                                		// 0x000C (0x0004) [0x0000000000000000]              
	// unsigned long                                   bSupported : 1;                                   		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameCrowdDestination_eventDecrementCustomerCount_Parms
{
	...
	// unsigned long                                   bIsInQueue : 1;                                   		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class AGameCrowdAgent*                             Agent;                                            		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bIgnoreRestrictions : 1;                          		// 0x0008 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	// int                                             I;                                                		// 0x000C (0x0004) [0x0000000000000000]              
...
struct AGameCrowdDestination_eventReachedDestination_Parms
{
	...
	// unsigned long                                   bEventActivated : 1;                              		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameCrowdDestination_execReachedByAgent_Parms
{
	...
	unsigned long                                      bTestExactly : 1;                                 		// 0x0014 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
...
{
	struct FCrowdSpawnInfoItem                         Item;                                             		// 0x0000 (0x0090) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	int                                                WarmupNum;                                        		// 0x0090 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0094 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct AGameCrowdPopulationManager_execValidateSpawnAt_Parms
{
	...
	unsigned long                                      ReturnValue : 1;                                  		// 0x0098 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
...
{
	struct FCrowdSpawnInfoItem                         Item;                                             		// 0x0000 (0x0090) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	int                                                StartIndex;                                       		// 0x0090 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                NumToUpdate;                                      		// 0x0094 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
struct AGameCrowdPopulationManager_execDisplayDebug_Parms
{
	...
	// unsigned long                                   bHasLOS : 1;                                      		// 0x00C4 (0x0004) [0x0000000000000000] [0x00000001] 
...
struct AGameExplosionActor_execExplode_Parms
{
	...
	// unsigned long                                   bHurtSomeone : 1;                                 		// 0x0020 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameExplosionActor_execDoExplosionDamage_Parms
{
	...
	// unsigned long                                   bDamageBlocked : 1;                               		// 0x004C (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bDoFullDamage : 1;                                		// 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bCauseFractureEffects : 1;                        		// 0x0054 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bCausePawnEffects : 1;                            		// 0x0058 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bCauseDamageEffects : 1;                          		// 0x005C (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bHurtSomeone : 1;                                 		// 0x0060 (0x0004) [0x0000000000000000] [0x00000001] 
	...
	// unsigned char                                   WantPhysChunksAndParticles;                       		// 0x00B8 (0x0001) [0x0000000000000000]              
...
struct ADebugCameraController_execConsoleCommand_Parms
{
	...
	unsigned long                                      bWriteToLog : 1;                                  		// 0x0010 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
{
	// int                                             I;                                                		// 0x0000 (0x0004) [0x0000000000000000]              
	// TArray< unsigned char >                         boolVars;                                         		// 0x0004 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct AMobileHUD_execDrawMobileDebugString_Parms
{
	...
	struct FString                                     Str;                                              		// 0x0008 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
struct UMobileMenuObject_execInitMenuObject_Parms
{
	...
	int                                                ScreenWidth;                                      		// 0x0010 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                ScreenHeight;                                     		// 0x0014 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bIsFirstInitialization : 1;                       		// 0x0018 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
...
{
	struct FString                                     Tag;                                              		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FString                                     Mode;                                             		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
{
	struct FString                                     MenuClassName;                                    		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     Mode;                                             		// 0x0010 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FString                                     MenuCommand;                                      		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FString                                     PendingURL;                                       		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	unsigned char                                      TravelType;                                       		// 0x0010 (0x0001) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bIsSeamlessTravel : 1;                            		// 0x0014 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	// int                                             I;                                                		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
struct UMobilePlayerInput_eventCloseMenuScene_Parms
{
	...
	// int                                             I;                                                		// 0x0008 (0x0004) [0x0000000000000000]              
	// int                                             Idx;                                              		// 0x000C (0x0004) [0x0000000000000000]              
	// unsigned long                                   bClosedTopMenu : 1;                               		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UMobilePlayerInput_eventOpenMenuScene_Parms
{
	...
	struct FString                                     Mode;                                             		// 0x0008 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FString                                     GroupName;                                        		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FString                                     ZoneName;                                         		// 0x0000 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
{
	struct FPostProcessSettings                        PP;                                               		// 0x0000 (0x0160) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct UGameThirdPersonCamera_execSetFocusOnActor_Parms
{
	...
	unsigned long                                      bAlwaysFocus : 1;                                 		// 0x0024 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      bAdjustCamera : 1;                                		// 0x0028 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      bIgnoreTrace : 1;                                 		// 0x002C (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
...
struct ADebugCameraHUD_eventPostRender_Parms
{
	...
	// struct FString                                  MyText;                                           		// 0x0018 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	// unsigned long                                   bFoundMaterial : 1;                               		// 0x009C (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct ADebugCameraHUD_execDisplayMaterials_Parms
{
	...
	// unsigned long                                   bDisplayedMaterial : 1;                           		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
...
struct AMobileDebugCameraHUD_eventPostRender_Parms
{
	...
	// struct FVector                                  HitNormal;                                        		// 0x0090 (0x000C) [0x0000000000000000]              
	// unsigned long                                   bFoundMaterial : 1;                               		// 0x009C (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bOldForceMobileHUD : 1;                           		// 0x00A0 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UMobileMenuBar_execRenderItem_Parms
{
	class UCanvas*                                     Canvas;                                           		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	float                                              DeltaTime;                                        		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                ItemIndex;                                        		// 0x000C (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
struct UMobileMenuBar_execAddItem_Parms
{
	...
	int                                                Index;                                            		// 0x0008 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
};
...
struct UMobileMenuInventory_execAddItemToSlot_Parms
{
	...
	int                                                ToSlot;                                           		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
...
struct UMobileMenuInventory_execCanPutItemInSlot_Parms
{
	...
	int                                                ToIdx;                                            		// 0x0010 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                FromIdx;                                          		// 0x0014 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0018 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UMobileMenuInventory_execDoCanPutItemInSlot_Parms
{
	...
	int                                                ToIdx;                                            		// 0x0018 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                FromIdx;                                          		// 0x001C (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x0020 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	class UMobileMenuInventory*                        FromInv;                                          		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	int                                                SlotIndex;                                        		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
struct UMobileMenuList_eventOnTouch_Parms
{
	...
	// unsigned long                                   bUdpateTouchItem : 1;                             		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct APlayerCollectorGame_eventLogin_Parms
{
	...
	struct FUniqueNetId                                UniqueId;                                         		// 0x0020 (0x0008) [0x0000000000000082]              ( CPF_Const | CPF_Parm )
	struct FString                                     ErrorMessage;                                     		// 0x0028 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	class APlayerController*                           ReturnValue;                                      		// 0x0038 (0x0008) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
