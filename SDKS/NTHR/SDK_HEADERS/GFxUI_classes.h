...
public:
	...
	unsigned long                                      bUnload : 1;                                      		// 0x0158 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x0150 (0x0008) [0x0000000000000000]              
	struct FString                                     Variable;                                         		// 0x0158 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x0150 (0x0008) [0x0000000000000000]              
	struct FString                                     MethodName;                                       		// 0x0158 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FASValue >                          Arguments;                                        		// 0x0168 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	class USwfMovie*                                   Movie;                                            		// 0x0150 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UClass*                                      MoviePlayerClass;                                 		// 0x0158 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UGFxMoviePlayer*                             MoviePlayer;                                      		// 0x0160 (0x0008) [0x0000000000000000]              
	unsigned long                                      bTakeFocus : 1;                                   		// 0x0168 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bCaptureInput : 1;                                		// 0x0168 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bStartPaused : 1;                                 		// 0x0168 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bEnableGammaCorrection : 1;                       		// 0x0168 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bDisplayWithHudOff : 1;                           		// 0x0168 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned char                                      RenderTextureMode;                                		// 0x016C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	class UTextureRenderTarget2D*                      RenderTexture;                                    		// 0x0170 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             CaptureKeys;                                      		// 0x0178 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             FocusIgnoreKeys;                                  		// 0x0188 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x0150 (0x0008) [0x0000000000000000]              
	TArray< struct FName >                             CaptureKeys;                                      		// 0x0158 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	class USwfMovie*                                   Movie;                                            		// 0x0170 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     FSCommand;                                        		// 0x0178 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33464 ];
