...
public:
	...
	char* GetPathName( UObject* StopOuter ); 
	char* GetFullName(); 
	...
	struct FString BaseTenString ( int Num );
	...
	// Virtual Functions
	virtual void VirtualFunction0000 ( );																		// 0x000000013F990A10 (0x0000)
	virtual void VirtualFunction0001 ( );																		// 0x000000013F8CA870 (0x0008)
	virtual void VirtualFunction0002 ( );																		// 0x000000013F8C8480 (0x0010)
	virtual void VirtualFunction0003 ( );																		// 0x000000013F990A10 (0x0018)
	virtual void VirtualFunction0004 ( );																		// 0x0000000140DB78A0 (0x0020)
	virtual void VirtualFunction0005 ( );																		// 0x0000000140DB78A0 (0x0028)
	virtual void VirtualFunction0006 ( );																		// 0x000000013F91BB60 (0x0030)
	virtual void VirtualFunction0007 ( );																		// 0x000000013F91BBC0 (0x0038)
	virtual void VirtualFunction0008 ( );																		// 0x000000013F89A760 (0x0040)
	virtual void VirtualFunction0009 ( );																		// 0x000000013F922020 (0x0048)
	virtual void VirtualFunction0010 ( );																		// 0x000000013F990A10 (0x0050)
	virtual void VirtualFunction0011 ( );																		// 0x000000013F916CA0 (0x0058)
	virtual void VirtualFunction0012 ( );																		// 0x000000013F8BC1B0 (0x0060)
	virtual void VirtualFunction0013 ( );																		// 0x000000013F8C6800 (0x0068)
	virtual void VirtualFunction0014 ( );																		// 0x000000013F711190 (0x0070)
	virtual void VirtualFunction0015 ( );																		// 0x0000000140DB78A0 (0x0078)
	virtual void VirtualFunction0016 ( );																		// 0x000000013F917D40 (0x0080)
	virtual void VirtualFunction0017 ( );																		// 0x000000013F915C40 (0x0088)
	virtual void VirtualFunction0018 ( );																		// 0x000000013F915C50 (0x0090)
	virtual void VirtualFunction0019 ( );																		// 0x000000013F917E10 (0x0098)
	virtual void VirtualFunction0020 ( );																		// 0x000000013F915E80 (0x00A0)
	virtual void VirtualFunction0021 ( );																		// 0x000000013F915C80 (0x00A8)
	virtual void VirtualFunction0022 ( );																		// 0x000000013F915E90 (0x00B0)
	virtual void VirtualFunction0023 ( );																		// 0x0000000140DB78A0 (0x00B8)
	virtual void VirtualFunction0024 ( );																		// 0x0000000140DB78A0 (0x00C0)
	virtual void VirtualFunction0025 ( );																		// 0x0000000140DB78A0 (0x00C8)
	virtual void VirtualFunction0026 ( );																		// 0x000000013F915C70 (0x00D0)
	virtual void VirtualFunction0027 ( );																		// 0x000000013F915C80 (0x00D8)
	virtual void VirtualFunction0028 ( );																		// 0x000000013F915E90 (0x00E0)
	virtual void VirtualFunction0029 ( );																		// 0x000000013F915C80 (0x00E8)
	virtual void VirtualFunction0030 ( );																		// 0x000000013F915E90 (0x00F0)
	virtual void VirtualFunction0031 ( );																		// 0x000000013F91B580 (0x00F8)
	virtual void VirtualFunction0032 ( );																		// 0x000000013F917F00 (0x0100)
	virtual void VirtualFunction0033 ( );																		// 0x000000013F918130 (0x0108)
	virtual void VirtualFunction0034 ( );																		// 0x0000000140DB78A0 (0x0110)
	virtual void VirtualFunction0035 ( );																		// 0x000000013F8B65E0 (0x0118)
	virtual void VirtualFunction0036 ( );																		// 0x000000013F92C4A0 (0x0120)
	virtual void VirtualFunction0037 ( );																		// 0x000000013F7111A0 (0x0128)
	virtual void VirtualFunction0038 ( );																		// 0x000000013F7111C0 (0x0130)
	virtual void VirtualFunction0039 ( );																		// 0x000000013F7111E0 (0x0138)
	virtual void VirtualFunction0040 ( );																		// 0x000000013F711200 (0x0140)
	virtual void VirtualFunction0041 ( );																		// 0x000000013FDFF900 (0x0148)
	virtual void VirtualFunction0042 ( );																		// 0x0000000140DB78A0 (0x0150)
	virtual void VirtualFunction0043 ( );																		// 0x0000000140DB78A0 (0x0158)
	virtual void VirtualFunction0044 ( );																		// 0x0000000140DB78A0 (0x0160)
	virtual void VirtualFunction0045 ( );																		// 0x000000013FDFF900 (0x0168)
	virtual void VirtualFunction0046 ( );																		// 0x000000013FF017B0 (0x0170)
	virtual void VirtualFunction0047 ( );																		// 0x000000013FF079E0 (0x0178)
	virtual void VirtualFunction0048 ( );																		// 0x000000013F8B6660 (0x0180)
	virtual void VirtualFunction0049 ( );																		// 0x000000013F8C0AF0 (0x0188)
	virtual void VirtualFunction0050 ( );																		// 0x0000000140DB78A0 (0x0190)
	virtual void VirtualFunction0051 ( );																		// 0x0000000140DB78A0 (0x0198)
	virtual void VirtualFunction0052 ( );																		// 0x000000013F89A560 (0x01A0)
	virtual void VirtualFunction0053 ( );																		// 0x000000013F8C8260 (0x01A8)
	virtual void VirtualFunction0054 ( );																		// 0x000000013F91A680 (0x01B0)
	virtual void VirtualFunction0055 ( );																		// 0x000000013FDFF900 (0x01B8)
	virtual void VirtualFunction0056 ( );																		// 0x000000013F915E30 (0x01C0)
	virtual void VirtualFunction0057 ( );																		// 0x000000013F91E490 (0x01C8)
	virtual void VirtualFunction0058 ( );																		// 0x000000013F87B620 (0x01D0)
	virtual void VirtualFunction0059 ( );																		// 0x000000013F92B720 (0x01D8)
	virtual void VirtualFunction0060 ( );																		// 0x0000000140DB78A0 (0x01E0)
	virtual void VirtualFunction0061 ( );																		// 0x000000013FDFF900 (0x01E8)
	virtual void VirtualFunction0062 ( );																		// 0x000000013F711150 (0x01F0)
	virtual void VirtualFunction0063 ( );																		// 0x000000013F711180 (0x01F8)
	virtual void VirtualFunction0064 ( );																		// 0x000000013F932B80 (0x0200)
	virtual void VirtualFunction0065 ( );																		// 0x000000013F915C90 (0x0208)
	virtual void VirtualFunction0066 ( );																		// 0x000000013F8C4CB0 (0x0210)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x000000013F8BB130 (0x0218)
};
...
public:
	...
	int                                                PropertiesSize;                                          // NOT AUTO-GENERATED PROPERTY 
...
{
public:
	DWORD                                              FunctionFlags;                                    		// NOT AUTO-GENERATED PROPERTY 
	WORD                                               iNative;                                          		// NOT AUTO-GENERATED PROPERTY 
	unsigned char                                      UnknownData00[ 0x22 ];                                   // NOT AUTO-GENERATED PROPERTY 
