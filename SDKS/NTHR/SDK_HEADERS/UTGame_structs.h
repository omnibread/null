...
struct FMessageRow
{
	class UGFxObject*                                  MC;                                               		// 0x0000 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  TF;                                               		// 0x0008 (0x0008) [0x0000000000000000]              
	float                                              StartFadeTime;                                    		// 0x0010 (0x0004) [0x0000000000000000]              
...
struct FGFxTween
{
	class UGFxObject*                                  TargetMC;                                         		// 0x0000 (0x0008) [0x0000000000000000]              
	float                                              TweenTime;                                        		// 0x0008 (0x0004) [0x0000000000000000]              
	float                                              Duration;                                         		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              StartValue;                                       		// 0x0010 (0x0004) [0x0000000000000000]              
	float                                              Delta;                                            		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              DesiredValue;                                     		// 0x0018 (0x0004) [0x0000000000000000]              
	struct FString                                     MemberName;                                       		// 0x001C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Callback;                                         		// 0x002C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FASDisplayInfo                              displayInfo;                                      		// 0x003C (0x002C) [0x0000000000000000]              
	unsigned long                                      bFinished : 1;                                    		// 0x0068 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned char                                      ThisTweenType;                                    		// 0x006C (0x0001) [0x0000000000000000]              
};
...
struct FItemData
{
	struct FString                                     ItemInfo;                                         		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ItemName;                                         		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      ItemFrame;                                        		// 0x0020 (0x0001) [0x0000000000000000]              
};
...
struct FViewInfo
{
	...
	struct FString                                     SWFName;                                          		// 0x0008 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct FString                                     OptionName;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     OptionLabel;                                      		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           OptionData;                                       		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct UGFxUDKFrontEnd_LaunchGame_FOption
{
	struct FString                                     OptionName;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     OptionLabel;                                      		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     OptionDesc;                                       		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FGameMapCycle
{
	...
	TArray< struct FString >                           Maps;                                             		// 0x0008 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FString                                     BotName;                                          		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bInUse : 1;                                       		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FListRow
{
	class UGFxObject*                                  MovieClip;                                        		// 0x0000 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  InnerMovieClip;                                   		// 0x0008 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  RankTF;                                           		// 0x0010 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  ScoreTF;                                          		// 0x0018 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  NameTF;                                           		// 0x0020 (0x0008) [0x0000000000000000]              
};
...
struct FUILeaderboardEntry
{
	...
	unsigned long                                      bLocalPlayer : 1;                                 		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FScoreRow
{
	class UGFxObject*                                  MovieClip;                                        		// 0x0000 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  InnerMovieClip;                                   		// 0x0008 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  DeathsTF;                                         		// 0x0010 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  ScoreTF;                                          		// 0x0018 (0x0008) [0x0000000000000000]              
	class UGFxObject*                                  NameTF;                                           		// 0x0020 (0x0008) [0x0000000000000000]              
};
...
struct FScoreboardState
{
	...
	struct FString                                     PlayerName;                                       		// 0x000C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      PlayerPlace;                                      		// 0x001C (0x0001) [0x0000000000000000]              
	float                                              PlayerScore;                                      		// 0x0020 (0x0004) [0x0000000000000000]              
...
{
	struct FString                                     PlayerName;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                PlayerScore;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                PlayerDeaths;                                     		// 0x0014 (0x0004) [0x0000000000000000]              
	unsigned long                                      bHasFlag : 1;                                     		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FUnitTestMultiMemberStruct
{
	...
	struct FString                                     StringMember1;                                    		// 0x000C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      BoolMember3 : 1;                                  		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              FloatMember3;                                     		// 0x0020 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< class UMaterialInterface* >                Materials;                                        		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FGibInfo
{
	...
	class UClass*                                      GibClass;                                         		// 0x0008 (0x0008) [0x0000000000000000]              
	unsigned long                                      bHighDetailOnly : 1;                              		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class AUTWeaponAttachment*                         TargetAttachment;                                 		// 0x0000 (0x0008) [0x0000000000000000]              
	class UParticleSystemComponent*                    Effect;                                           		// 0x0008 (0x0008) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
{
	class AUTPlayerReplicationInfo*                    PRI;                                              		// 0x0000 (0x0008) [0x0000000000000000]              
...
struct FDamageInfo
{
	...
	class UMaterialInstanceConstant*                   MatConstant;                                      		// 0x0008 (0x0008) [0x0000000000000000]              
};
...
struct FGameSearchSettingsStorage
{
	...
	TArray< struct FPersistentLocalizedSettingValue >  StoredValues;                                     		// 0x0008 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
};
...
struct FPendingORFilter
{
	...
	unsigned char                                      Operator;                                         		// 0x0011 (0x0001) [0x0000000000000000]              
	struct FString                                     Value;                                            		// 0x0014 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bRawFilter : 1;                                   		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	TArray< struct FPendingORFilter >                  ORFilters;                                        		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       GroupName;                                        		// 0x0010 (0x0008) [0x0000000000000000]              
};
...
{
	class UStaticMesh*                                 TheStaticMesh;                                    		// 0x0000 (0x0008) [0x0000000000000000]              
	class USkeletalMesh*                               TheSkelMesh;                                      		// 0x0008 (0x0008) [0x0000000000000000]              
	class UPhysicsAsset*                               ThePhysAsset;                                     		// 0x0010 (0x0008) [0x0000000000000000]              
	float                                              DrawScale;                                        		// 0x0018 (0x0004) [0x0000000000000000]              
	unsigned long                                      bUseSecondaryGibMeshMITV : 1;                     		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FAmmoStore
{
	...
	class UClass*                                      WeaponClass;                                      		// 0x0004 (0x0008) [0x0000000000000000]              
};
...
struct FWeaponEntry
{
	...
	class UPrimitiveComponent*                         PickupMesh;                                       		// 0x0008 (0x0008) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FPawnToucher
{
	...
	float                                              NextTouchTime;                                    		// 0x0008 (0x0004) [0x0000000000000000]              
};
