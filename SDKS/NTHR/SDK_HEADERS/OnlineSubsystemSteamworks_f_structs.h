...
struct UOnlineSubsystemSteamworks_execOnWriteSharedFileComplete_Parms
{
	...
	struct FString                                     SharedHandle;                                     		// 0x0024 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
{
	unsigned long                                      bWasSuccessful : 1;                               		// 0x0000 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	struct FString                                     SharedHandle;                                     		// 0x0004 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
struct UOnlineSubsystemSteamworks_execGetCommandlineJoinURL_Parms
{
	...
	struct FString                                     ServerURL;                                        		// 0x0004 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	struct FString                                     ServerUID;                                        		// 0x0014 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
...
{
	unsigned char                                      LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
	struct FString                                     SubURL;                                           		// 0x0004 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
struct UOnlineSubsystemSteamworks_execShowCustomMessageUI_Parms
{
	...
	struct FString                                     MessageTitle;                                     		// 0x0014 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     NonEditableMessage;                               		// 0x0024 (0x0010) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     EditableMessage;                                  		// 0x0034 (0x0010) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
// [0x00020002] 
struct UOnlineSubsystemSteamworks_execLocalUnMuteAll_Parms
{
};

// Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.LocalMuteAll
// [0x00020002] 
struct UOnlineSubsystemSteamworks_execLocalMuteAll_Parms
{
};
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execShowWebPageUI_Parms
{
	unsigned char                                      LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
...
// [0x00020400] ( FUNC_Native )
struct UOnlineSubsystemSteamworks_execCreateAuthInterface_Parms
{
