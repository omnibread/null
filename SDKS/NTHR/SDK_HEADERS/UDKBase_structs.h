...
struct FDrivenWeaponPawnInfo
{
	...
	unsigned char                                      SeatIndex;                                        		// 0x0008 (0x0001) [0x0000000000000000]              
...
struct FUTTakeHitInfo
{
	...
	struct FVector                                     AttackerLocation;                                 		// 0x002C (0x000C) [0x0000000000000000]              
};
...
struct FEmoteInfo
{
	...
	struct FString                                     EmoteName;                                        		// 0x0010 (0x0010) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FName                                       EmoteAnim;                                        		// 0x0020 (0x0008) [0x0000000000000000]              
	unsigned long                                      bVictoryEmote : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bTopHalfEmote : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000002] 
	struct FName                                       Command;                                          		// 0x002C (0x0008) [0x0000000000000000]              
	unsigned long                                      bRequiresPlayer : 1;                              		// 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FEStringListData
{
	...
	struct FString                                     ColumnHeaderText;                                 		// 0x0008 (0x0010) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     CurrentValue;                                     		// 0x0018 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                DefaultValueIndex;                                		// 0x0028 (0x0004) [0x0000000000000000]              
	TArray< struct FString >                           Strings;                                          		// 0x002C (0x0010) [0x0000000000408002]              ( CPF_Const | CPF_Localized | CPF_NeedCtorLink )
...
struct FVehicleSeat
{
	...
	int                                                BarrelIndex;                                      		// 0x0040 (0x0004) [0x0000000000000000]              
	struct FString                                     TurretVarPrefix;                                  		// 0x0044 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	unsigned long                                      bDisableOffsetZAdjust : 1;                        		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000001] 
	...
	unsigned long                                      bSeatVisible : 1;                                 		// 0x011C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
struct FVehicleAnim
{
	...
	unsigned long                                      bAnimLoopLastSeq : 1;                             		// 0x001C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
struct FFDamageMorphTargets
{
	...
	int                                                LinkedMorphNodeIndex;                             		// 0x0018 (0x0004) [0x0000000000000000]              
	struct FName                                       InfluenceBone;                                    		// 0x001C (0x0008) [0x0000000000000000]              
	int                                                Health;                                           		// 0x0024 (0x0004) [0x0000000000000000]              
