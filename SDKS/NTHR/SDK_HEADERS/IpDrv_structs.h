...
struct FMcpClashMobChallengeUserStatus
{
	...
	struct FString                                     accept_time;                                      		// 0x0044 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      did_preregister : 1;                              		// 0x0054 (0x0004) [0x0000000000000000] [0x00000001] 
	struct FString                                     facebook_like_time;                               		// 0x0058 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      enrolled_via_facebook : 1;                        		// 0x0068 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      liked_via_facebook : 1;                           		// 0x0068 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      commented_via_facebook : 1;                       		// 0x0068 (0x0004) [0x0000000000000000] [0x00000004] 
	struct FString                                     twitter_retweet_time;                             		// 0x006C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      enrolled_via_twitter : 1;                         		// 0x007C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      retweeted : 1;                                    		// 0x007C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	struct FString                                     CreationDate;                                     		// 0x0034 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     LastUpdateDate;                                   		// 0x0044 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     CompressionType;                                  		// 0x0054 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
