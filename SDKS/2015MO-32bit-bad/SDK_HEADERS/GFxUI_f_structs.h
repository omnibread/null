...
struct UGFxMoviePlayer_eventSetMovieCanReceiveKeyInput_Parms
{
	unsigned long                                      bCanReceiveKeyInput : 1;                          		// 0x0000 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
};

// Function GFxUI.GFxMoviePlayer.SetFocus
// [0x00024802] ( FUNC_Event )
struct UGFxMoviePlayer_eventSetFocus_Parms
{
...
// [0x00820002] 
struct UGFxObject_execFixStereoFOV_Parms
{
	unsigned long                                      bStereoEnabledNow : 1;                            		// 0x0000 (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
	// struct FASDisplayInfo                           dinfo;                                            		// 0x0004 (0x0030) [0x0000000000000000]              
	// class UStereo3D*                                s3d;                                              		// 0x0034 (0x0004) [0x0000000000000000]              
};
...
{
	int                                                Index;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FASDisplayInfo                              D;                                                		// 0x0004 (0x0030) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	int                                                Index;                                            		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FASDisplayInfo                              ReturnValue;                                      		// 0x0004 (0x0030) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FASDisplayInfo                              D;                                                		// 0x0000 (0x0030) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	struct FASDisplayInfo                              ReturnValue;                                      		// 0x0000 (0x0030) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
