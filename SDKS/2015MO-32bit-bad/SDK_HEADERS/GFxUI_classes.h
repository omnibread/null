...
public:
	...
	unsigned long                                      bFollowHmdRotation : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00100000] 
	...
	float                                              HmdExtraDepth;                                    		// 0x015C (0x0004) [0x0000000000000000]              
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                        		// 0x0160 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	void eventSetMovieCanReceiveKeyInput ( unsigned long bCanReceiveKeyInput );
	void eventSetFocus ( unsigned long CaptureInput, unsigned long Focus );
...
public:
	...
	void FixStereoFOV ( unsigned long bStereoEnabledNow );
	bool eventWidgetUnloaded ( struct FName WidgetName, struct FName WidgetPath, class UGFxObject* Widget );
	bool eventWidgetInitialized ( struct FName WidgetName, struct FName WidgetPath, class UGFxObject* Widget );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 36931 ];
