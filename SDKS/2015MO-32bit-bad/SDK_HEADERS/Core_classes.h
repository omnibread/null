...
public:
	...
	bool IsPendingKill ( );
	struct FString SecondsToString ( int iSec );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x014749D0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x014313C0 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x0142F430 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x01C1D890 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x024424F0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x020243B0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x014606D0 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x01460720 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x0140D570 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x01462030 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x014749D0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x014610A0 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x01426DD0 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x0142D840 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x013FDA40 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x020243B0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x01461B30 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x01460440 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x01460450 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x01461C00 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x01460640 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x01460480 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x01460610 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x020243B0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x020243B0 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x0202F5A0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x01460470 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x01460480 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x01460610 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x01460480 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x01460610 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x01463580 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x01461CF0 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x01461E90 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x020243B0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x01420550 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x0146E4C0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x013D5940 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x013D5970 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x013D59A0 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x013D6C30 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x02249FF0 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x0202F5A0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x0202F5A0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x020243B0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x02249FF0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x018C6AD0 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x018CBA50 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x014205D0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x014295C0 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x024424F0 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x024424F0 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x0140D3F0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x0142F180 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x01463180 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x01D80080 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x014605F0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x01461750 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x013FB590 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x0146DCF0 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x02249FF0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x013D4280 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x013D42A0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x014716C0 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x01460490 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x0142C360 (0x104)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x01425C50 (0x108)
};
...
{
public:
	unsigned char                                      UnknownData00[ 0x130 ];                           		// 0x003C (0x0130) MISSED OFFSET
...
// 0x00A8 (0x0214 - 0x016C)
class ULinkerSave : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0xA8 ];                            		// 0x016C (0x00A8) MISSED OFFSET
...
// 0x05C8 (0x0734 - 0x016C)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x5C8 ];                           		// 0x016C (0x05C8) MISSED OFFSET
